...
def get_shakespeare_data():
    ...
    if not os.path.exists(
        os.path.join(os.path.dirname(__file__), "shakespeare_train.bin")
    ) or not os.path.exists(
        os.path.join(os.path.dirname(__file__), "shakespeare_val.bin")
    ):
    ...
    val_ids = np.fromfile(
        os.path.join(os.path.dirname(__file__), "shakespeare_val.bin"), dtype=np.uint16
    )
